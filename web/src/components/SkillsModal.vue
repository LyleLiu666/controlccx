                ...
                <div class="skillsCell">
                  <template v-for="t in [summarizeTarget(s, 'cursor')]" :key="t.target">
                    ...
                    <button
                      ...
                      :disabled="
                        !t.canEnable || !!actionBusy.get(makeKey(s.name, 'cursor'))
                      "
                      :title="
                        t.canEnable
                          ? 'Enable for Cursor'
                    ...
                    <button
                      ...
                      :disabled="
                        !t.canDisable || !!actionBusy.get(makeKey(s.name, 'cursor'))
                      "
                      :title="
                        t.canDisable
                          ? 'Disable for Cursor'
                ...
                <div class="skillsCell">
                  <template v-for="t in [summarizeTarget(s, 'claude_code')]" :key="t.target">
                    ...
                    <button
                      ...
                      :disabled="
                        !t.canEnable ||
                        !!actionBusy.get(makeKey(s.name, 'claude_code'))
                      "
                      :title="
                        t.canEnable
                ...
                <div class="skillsCell">
                  <template v-for="t in [summarizeTarget(s, 'codex')]" :key="t.target">
                    ...
                    <button
                      ...
                      :disabled="
                        !t.canEnable || !!actionBusy.get(makeKey(s.name, 'codex'))
                      "
                      :title="
                        t.canEnable
                          ? 'Enable for Codex'
                    ...
                    <button
                      ...
                      :disabled="
                        !t.canDisable || !!actionBusy.get(makeKey(s.name, 'codex'))
                      "
                      :title="
                        t.canDisable
                          ? 'Disable for Codex'
