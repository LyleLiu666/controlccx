    ...
    <details class="skillsGovDetails" open>
      ...
      <div v-if="op === 'local'" class="skillsGovOp">
        ...
        <div class="skillsGovForm">
          <input v-model="gov.localSourcePath" placeholder="本地路径（必填）例如：/path/to/skills/foo" />
          <input v-model="gov.localName" placeholder="技能名（可选，默认从目录推断）" />
      ...
      <div v-else-if="op === 'git'" class="skillsGovOp">
        ...
        <div class="skillsGovForm">
          <input v-model="gov.gitRepoURL" placeholder="仓库地址（必填）例如：https://github.com/user/repo" />
          <button type="button" @click="gov.runListGitCandidates" :disabled="gov.gitCandidatesLoading || !canInstallGit">
        ...
        <div class="skillsGovForm">
          <input v-model="gov.gitName" placeholder="技能名（可选）" />
          <label class="skillsGovCheckbox">
      ...
      <div v-else-if="op === 'import'" class="skillsGovOp">
        ...
        <div class="skillsGovForm">
          <input v-model="gov.importName" placeholder="技能名（必填）" />
          <input v-model="gov.importTool" placeholder="工具 key（可选）例如：cursor" />
          <input v-model="gov.importSourcePath" placeholder="源路径（必填）例如：/path/to/skill" />
          <label class="skillsGovCheckbox">
      ...
      <div v-else-if="op === 'sync'" class="skillsGovOp">
        ...
        <div class="skillsGovForm">
          <input v-model="gov.syncName" placeholder="技能名（必填）" />
      ...
      <div v-else-if="op === 'update'" class="skillsGovOp">
        ...
        <div class="skillsGovForm">
          <input v-model="gov.updateName" placeholder="技能名（必填）" />
          <button
            type="button"
            class="primary"
            @click="gov.runUpdate"
